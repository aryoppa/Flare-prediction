...
def load_and_preprocess_data(split_ratio):
    ...
    image_features = np.load(os.path.join(base_dir, "sdo_image_features_2015-2025.npy"))
    valid_data = pd.read_csv(os.path.join(base_dir, "Flare Merge 2015 - 2025.csv"))
    ...
    # Final label array
    labels = valid_data['flare_class_idx'].values
    ...
    # Time-based split
    split_index = int(len(valid_data) * split_ratio / 100)
