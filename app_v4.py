# Updated full script including log-scaled weight training
...
# --- Training: Log-Scaled Weight ---
model_log_scaled, history_log_scaled, y_pred_log_scaled = train_and_eval_tcn(
    X_train_tcn, y_train_cat, X_test_tcn, y_test_cat,
    num_classes, class_weight=log_scaled_class_weight, mode_name="log_scaled_weight"
)
