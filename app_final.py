...
split_ratio = 70  # 70% train, 30% test
...
for window_size in window_sizes:
    ...
    # Hitung class_weight dan log_scaled_weight dari label sebelum oversampling
    ...
    for mode_name, cweight in [
        ...
        for idx, cname in enumerate(target_names):
            ...
            n_correct = np.sum((y_test_true == idx) & (y_test_pred == idx))
...
csv_path = os.path.join(OUTDIR, "model_eval_per_class_v4.csv")
