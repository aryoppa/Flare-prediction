...
csv_path = "/Users/aryobagaspamungkas/Flare-prediction/data/datasets/model_eval_per_class_v2.csv"
df = pd.read_csv(csv_path)
flare_classes = ['A', 'B', 'C', 'M', 'X']
...
full_results_df.to_csv("model_eval_per_class_long_2.csv", index=False)
